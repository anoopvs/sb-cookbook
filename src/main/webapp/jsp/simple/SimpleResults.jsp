...
<hr noshade="noshade"/>
<p>Hello ${simpleForm.name},</p>
<p><strong>You told me a secret:</strong> ${simpleForm.secret}</p>
<p><strong>You said that your favorite color is:</strong> ${simpleForm.color}</p>
<c:if test="${simpleForm.confirm eq true}">
<p>You confirmed that this <em>is</em> your favorite color.</p>
</c:if>
<c:if test="${not simpleForm.confirm eq true}">
